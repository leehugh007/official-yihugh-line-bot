...
const METABOLISM_REPORTS = {
  highRPM: {
    ...
    trap:
      ...
      '✨ 真正要做的事，跟你過去學的完全相反——\n' +
      '不是更用力踩油門，是學會切換檔位。\n' +
      '高強度運動減到 2-3 次/週就夠，其他天改成走路、伸展、瑜伽，\n' +
      '睡前 1 小時放下手機，讓副交感神經有機會啟動。\n\n' +
  ...
  powerSave: {
    ...
    trap:
      ...
      '保護機制，是可以關掉的。\n\n' +
      '✨ 真正要做的事，跟你過去學的完全相反——\n' +
      '先停掉任何形式的「限制」，三餐好好吃、吃到飽，\n' +
      '把蛋白質和好油補足，讓身體相信「主人不會再餓我了」，\n' +
      '它才會願意把代謝重新打開。\n\n' +
  ...
  steady: {
    ...
    trap:
      ...
      '而不是待在原地。\n\n' +
      '✨ 真正要做的是精進，不是重來：\n' +
      '把水果濃縮製品換成原型水果（一天一份就夠），\n' +
      '蛋白質補到每公斤體重 1.2-1.6g，\n' +
      '加入 12-14 小時的休息窗口——晚上 8 點後不吃、早上 8 點再開始，\n' +
