...
// 對齊阿算的五型命名（abc-line-bot chineseTypeMap）
const TYPE_NAMES = {
  highRPM: '高轉速型',
  rollercoaster: '雲霄飛車型',
  burnout: '燃燒殆盡型',
...
所以我最近讓我的 AI 助理「阿算」做一件事：幫你看 3 天的餐。你吃什麼就拍照傳給它，它會用你的代謝類型告訴你這一餐是加分還是扣分，3 天後給你一份你自己的飲食盲點報告，不需要費用。
...
我最近讓我的 AI 助理「阿算」幫人看 3 天的餐：你吃什麼拍照傳給它，它會告訴你這一餐對你的代謝是加分還是扣分，3 天後給你一份你自己的飲食盲點報告，不需要費用。
