...
const SETTING_SCHEMA = {
  ...
  q5_msg3_template: 'string',
  q5_msg4_template: 'string',
  // /apply 方案說明（2026-08-12 一休：後台可編輯；預設=原寫死文案）
  apply_plan12_desc: 'string',
  apply_plan12_bullets: 'string',
  apply_plan4_desc: 'string',
  apply_plan_duo_desc: 'string',
  // 3天看餐體驗自動邀請（lib/trial-invite.js）
  trial_invite_enabled: 'bool',
  trial_invite_restricted: 'bool',
  trial_invite_daily_cap: 'int',
  trial_invite_on_follow: 'bool',
};
