...
function buildMsg3Text(pricing) {
  ...
  const priceLines = `‧ ${superDateStr} 前 — 超早鳥 $${superPrice.toLocaleString()}
‧ ${regularStartStr}–${regularEndStr} — 常規早鳥 $${regularPrice.toLocaleString()}
